...
var img=["small1.jpg","small2.jpg","small3.jpg"];
var fs = require('fs');
...
function serve(req,res){
  ...
  if(pathname == '/'){//如果访问的是根目录
    ...
    res.write('请点菜');
    res.write('<ul>');
    menus.forEach(function(menu,n){
      res.write('<li><a href="/pick/'+menu.name+'?unit='+menu.unit+'">'+menu.name+'<img style="width:100;height:100" src='+img[n]+'/></a></li>');
    });
    res.write('</ul>');
    res.end();//结束响应
...
server.listen(5555,'localhost');//让别人能找到你
